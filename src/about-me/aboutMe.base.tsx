          ...
          <div className={styles.welcomeSubContainer}>
            <div style={{ width: "75%" }}>
              ...
              <div className={styles.iconTray}>
                <a href="https://github.com/ramon-verdinperez" target="_blank" rel="noreferrer"><img src={gitIcon} alt="Github Icon" /></a>
                <a href="https://www.linkedin.com/in/ramon-v-4762b7133/" target="_blank" rel="noreferrer"><img src={linkedInIcon} alt="Linked In Icon"/></a>
              </div>
            </div>
          </div>
          <div className={styles.welcomeSubContainer}>
