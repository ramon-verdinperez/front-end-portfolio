            ...
            <div className="accordianPanelOuter">
                ...
                <div className="questionContainer">
                    {questions.map((q: QuestionDropDownProps, index: number) => {
                        return(
                            <div key={index} onClick={() => setSelectedFAQ(selectedFAQ === index ? undefined : index)}>
                                <QuestionDropDown question={q.question} description={q.description} isSelected={selectedFAQ === index}/>
